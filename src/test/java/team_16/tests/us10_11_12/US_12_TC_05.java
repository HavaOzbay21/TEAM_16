...
public class US_12_TC_05 {
    ...
    public void TC_05() throws IOException {
        ...
        billingAddress.townCity.sendKeys(ConfigReader.getProperty("sehri_town"), Keys.TAB,ConfigReader.getProperty("sehri_state"));
        ...
        ReusableMethods.scrollIntoViewJS(billingAddress.alertCountry);
