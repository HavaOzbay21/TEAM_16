...
public class TC_01 {
    ...
    public void tc04() throws InterruptedException {
        ...
        billingDetails.codeBoslugu.sendKeys(ConfigReader.getProperty("indirimKuponu"),Keys.TAB,Keys.ENTER);

        Assert.assertTrue(billingDetails.kuponIndirimiGorunurlugu.isDisplayed());
